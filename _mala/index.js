...
mongoose
  .connect(
    "mongodb+srv://alvaro:alvaro@cluster0.tetdq54.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0"
  )
  .then(() => {
...
>>>>>>> 7e824f4fc507f604a945878205e0500c3292e60a:_mala/index.js
    }
...
app.get("/users/:userId/tasks", async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ error: "Internal server error", userId: req.params.userId });
  }
});
