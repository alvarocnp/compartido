...
const myDay = () => {
    ...
    const getUserTasks = async () => {
        try {
          ...
          const response = await axios.get(`http://192.168.1.159:3000/tasks/all/${selectedDate}/${userId}`);
          setTasks(response.data.tasks);

          const tasksListadas = response.data.tasks || [];
    ...
    const addTask = async () => {
        ...
        try {
            ...
            const userId = await AsyncStorage.getItem("userId");
            console.log(userId)
            axios.post(`http://192.168.1.159:3000/tasks/${userId}`, taskData).then((response) => {
            }).catch((error) => {
                console.log("error", error)
            });
    ...
    /*const getUserTasks = async () => {
        try {
            const userId = await AsyncStorage.getItem("userId");
            const res = await axios.get(`http://192.168.1.159:3000/users/${userId}/tasks`)
            console.log(userId);
